...
public class PlayerCameraBob
{
    ...
    public PlayerCameraBob(Transform camera_bob, Transform camera_handler)
    {
    ...
    private void ResetPos(float delta)
    {
        m_camera_bob_transfrom.localPosition = Vector3.Lerp(m_camera_bob_transfrom.localPosition, Vector3.zero, m_deceleration * delta);
        m_camera_bob_transfrom.localRotation = Quaternion.Lerp(m_camera_bob_transfrom.localRotation, Quaternion.identity, m_deceleration * delta);
    }
