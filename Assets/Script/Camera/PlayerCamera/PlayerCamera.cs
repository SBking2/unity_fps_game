...
public class PlayerCamera
{
    ...
    private PlayerCameraBob m_camera_bob;

    public PlayerCamera(Transform player_transform, Transform camera_vertical_transform, Transform camera_bob)
    {
        m_camera_bob = new PlayerCameraBob(camera_bob, camera_vertical_transform);
        m_player_transform = player_transform;
        m_camera_vertical_handler = camera_vertical_transform;
    }

    public void Update(float delta, float amp_multiplier, float fre_multiplier, bool is_player_ground)
    {
        HandleCamera(delta);
        m_camera_bob.Update(delta, amp_multiplier, fre_multiplier, is_player_ground);
    }
